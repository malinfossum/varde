...
| 217 | Unge Relasjoner | Oslo | | vold-og-overgrep, psykisk-helse | | https://www.ungerelasjoner.no/ | https://www.ungerelasjoner.no | Chat tirsdag 12–20 og fredag 12–15 | https://www.ungerelasjoner.no/ | 2026-08-13 | ☑ | Chat only, no phone — do not present as a crisis line. Run by Oslo Krisesenter, but the site describes it as a national chat; reclassify the municipality if that matters. Hours read verbatim: "Chatten er åpen tirsdag 12 - 20 og fredag 12-15". Age 16–25. |
