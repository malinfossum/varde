...
2026-08-17, my decision: no phone calls — source verification is sufficient; conflicts resolve by
...
they are recorded in Notes only, so I can decide whether they are service lines.
...
| 112 | Rask psykisk helsehjelp (RPH), Løten kommune | Løten | | psykisk-helse | | | https://www.loten.kommune.no/helse-sosial-og-familie/psykisk-helse-og-rus/rask-psykisk-helsehjelp-rph/ | kl. 08.00-15.30 | https://www.loten.kommune.no/helse-sosial-og-familie/psykisk-helse-og-rus/rask-psykisk-helsehjelp-rph/ | 2026-08-13 | ☑ | RESOLVED 2026-08-17: seed with empty phone — my decision. The only numbers on the page are listed under two first names ("Pål 415 58 006", "Andrine 917 41 079") — individual therapists' mobiles, not a service line; they are NOT seeded and no call is needed. The row ships website-only. Kildevegen 1, 2340 Løten. Free, age 16+, no referral needed. |
...
2. Row 112: seeds with empty phone (my decision). ✅
...
8. Arbeidslivstelefonen: 116 123 (tast 3) ships — the org's primary published route; the
   22 56 67 00 sighting on Sidetmedord is noted but not shipped (my decision). ✅
